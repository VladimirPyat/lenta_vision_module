...
if __name__ == "__main__":
    model_path = "bin/yolo-12s_prices.pt"
    video_path="../_download/25_12-20.mp4"
    try:
        run_inference(model_path=model_path, video_path=video_path, show=True, skip=0)
    except Exception:
